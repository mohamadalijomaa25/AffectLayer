  ...
  const handleSpeak = async () => {
    ...
    if (elevenLabsKey) {
      ...
      try {
        ...
        alert("Failed to connect to ElevenLabs API. Please check your API key.");
        setSpeaking(false);
      }
    } else {
      alert("Please configure your ElevenLabs API Key in Settings (top right) to use the ultra-realistic AI voice.");
      setSpeaking(false);
    }
  };
